...
export default Ember.Component.extend({
  permissions: service(),
  tagName: 'li',
  classNameBindings: ['lastBuild.state', 'repo.active:is-active'],
  ...
  lastBuild: alias('repo.default_branch.last_build'),

  urlGithubCommit: function() {
    return githubCommitUrl(this.get('repo.slug'), this.get('lastBuild.commit.sha'));
  }.property('repo.slug', 'lastBuild.commit.sha'),
